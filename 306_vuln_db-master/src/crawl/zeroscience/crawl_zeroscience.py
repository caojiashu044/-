...
from crawl.dataProce import insert_mongo, queryrepeat, init_item, getDeepin, isInDeepin


class Zeroscience(object):
                ...
                if h2 is not None:
                    ...
                    for tag in h5_tags:
                        ...
                        if tag.text == 'PoC':
                            ...
                            r1 = requests.get(poc_url, headers=self.headers)
